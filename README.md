...
## 🚀 Tính năng nổi bật
* **Đa nền tảng:** Hỗ trợ quét và tải mượt mà từ nhiều website lớn như: `17k`, `22biqu`, `52shuku`, `69shuba`, `biquge`, `fanqienovel`, `jjwxc`, `kakuyomu`, `novel543`, `pixiv`, `qidian`, `syosetu`, `uukanshu`.
...
Excerpo được cung cấp **miễn phí cho mục đích sử dụng cá nhân**. Để duy trì chi phí phát triển, công cụ có tích hợp cơ chế tự động mở một tab quảng cáo ẩn dưới nền (tự đóng sau 10 giây) trong quá trình tải. 
